...
reagent-desc-ethyloxyephedrine = Нестабильное лекарственное средство, получаемое из метамфетамин а. Поскольку основные эффекты метамфетамин а нейтрализованы, он может пригодиться для чего-то ещё.
