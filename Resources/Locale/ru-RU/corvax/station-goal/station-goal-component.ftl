...
station-goal-shuttle =
    ...
    Инженерному отделу необходимо построить его, а научно-исследовательский отдел должен предоставить инженерному отделу и шаттлу всю необходимую экипировку.
